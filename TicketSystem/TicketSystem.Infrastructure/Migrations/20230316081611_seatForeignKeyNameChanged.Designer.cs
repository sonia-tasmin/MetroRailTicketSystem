...
namespace TicketSystem.Infrastructure.Migrations
{
    ...
    [Migration("20230316081611_seatForeignKeyNameChanged")]
    partial class seatForeignKeyNameChanged
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TicketSystem.Core.Entities.Seat", b =>
                {
                    b.HasOne("TicketSystem.Core.Entities.RouteTrain", "RouteTrain")
                        .WithMany()
                        .HasForeignKey("RouteTrainId")
                        .OnDelete(DeleteBehavior.ClientNoAction)
                        .IsRequired();

                    b.Navigation("RouteTrain");
                });
