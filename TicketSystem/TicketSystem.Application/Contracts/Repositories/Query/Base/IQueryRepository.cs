...
namespace TicketSystem.Application.Contracts.Repositories.Query.Base
{
    public interface IQueryRepository<TEntity> where TEntity : class
    {
        ...
        /// <param name="isProcedure"></param>
        /// <returns></returns>
        Task<IEnumerable<TEntity>> GetAsync<TFirst, TSecond, TEntity>(string sql, Func<TFirst, TSecond, TEntity> map, DynamicParameters parameters, string splitters = "Id", bool isProcedure = false)
            where TFirst : class
            where TSecond : class
            where TEntity : class;
        ...
        /// <param name="isProcedure"></param>
        /// <returns></returns>
        Task<TEntity> SingleAsync<TFirst, TSecond, TEntity>(string sql, Func<TFirst, TSecond, TEntity> map, DynamicParameters parameters, bool isProcedure = false)
            where TFirst : class
            where TSecond : class;
